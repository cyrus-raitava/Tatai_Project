...
public class InstructionsController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		dataPane.appendText("\n");
		dataPane.appendText("\nYou will start on the Easy Level, and then progress through Medium, to Hard, and finally Custom.");
		...
		dataPane.appendText("\n\nYou can only unlock the Medium Level after you have gotten 8/10 or more in the Easy Level, and so on with the other levels.");
